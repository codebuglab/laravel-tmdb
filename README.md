...
- [Instructions](#Instructions)
    ...
    - [Collections](#collections)
        ...
        - [Get Translations](#get-transactions)
    - [Companies](#companies)
        - [Get Details](#get-details)
    ...
    - [TV](#tv)
        ...
        - [Get TV On The- Air](#get-tv-on-the-air)
        - [Get Popular](#get-popular)
        - [Get Top Rated](#get-top-rated)
...
- Then you have to put your tmdb api keyin your `env` file like this `TMDB_API_KEY=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`.
